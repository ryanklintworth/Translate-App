          ...
          <div id="modal-textbox">
            <form onSubmit={this.handleSubmit}>
              ...
              <label htmlFor="location"><p className="inputText">Location</p></label>
                <input type="text" className="textbox" onChange={this.handleChange} />
                <br/><br/>
                <input id="updatebtn" onClick={this.closeModal} type="submit" value="Create" />
            </form>
            <br/>
            <button id="closeModal" onClick={this.closeModal}>Cancel</button>
          </div>
        </div>
        <button className="btn waves-effect waves-light" onClick={this.openModal}> Post an item for sale </button>
